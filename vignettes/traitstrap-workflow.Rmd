...
# Because dbFD returns output as a list, we need to do a bit of work to wrangle
# it into a more useful format
# We'll extract Rao's Quadratic Entropy, since that performs well with
# bootstrapping.
...
# for each replicated site, convert the distribution into a trait probability
# distribution and then derive functional diversity metrics
