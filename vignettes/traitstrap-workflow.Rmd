...
We can in fact estimate the variance and other parameters of these trait distributions.
...
In traitstrap both the parametric and nonparametric bootstrapping functions allow returing raw trait distributions.
